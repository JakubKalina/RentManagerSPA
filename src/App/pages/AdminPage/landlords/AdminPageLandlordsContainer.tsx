...
import { renderAdminTableColumnsForAdmin } from "./utils/LandlordsTableForAdmin";

const { LOADING, SUCCESS } = StatusType;


const AdminPageLandlordsContainer: React.FC<{}> = () => {
        ...
        <div>
            ...
            <div>
                ...
                {(userRole === 'Administrator') && (searchQuery != '') ? 
                    ...
                    dataSource={users.filter(u => u.role === 'Landlord')}
                    rowKey='id'
                    />:
                    null
                }
...
export default AdminPageLandlordsContainer;