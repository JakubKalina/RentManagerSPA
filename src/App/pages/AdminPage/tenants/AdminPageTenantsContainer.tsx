...
import { renderAdminTableColumnsForAdmin } from "./utils/TenantsTableForAdmin";

const { LOADING, SUCCESS } = StatusType;


const AdminPageTenantsContainer: React.FC<{}> = () => {
        ...
        <div>
			...
			{status === StatusType.LOADING ?
				...
				<Row align='middle' justify='center'>
					<Col xs={22} md={14} xl={10} xxl={8}>
						...
						<PageHeader title={'Znajdź najemcę'} />
            ...
            <div>
                ...
                {(userRole === 'Administrator') && (searchQuery != '') ? 
                    ...
                    dataSource={users.filter(u => u.role === 'Tenant')}
                    rowKey='id'
                    />:
                    null
                }
...
export default AdminPageTenantsContainer;